...
public class BusinessAuthController {
    ...
    // --- NEW: Logout Endpoint ---
    // Bu endpointə yalnız autentifikasiya olunmuş istifadəçilər daxil ola bilər.
    // Başlıqlarda JWT token göndərilməlidir.
    @PostMapping("/logout")
    ...
    public ResponseEntity<AuthResponse> logout(Authentication authentication) {
        // authentication obyektindən cari istifadəçinin username-ini alırıq
